...
describe "Categories" do
  ...
  describe "Manage categories" do
    context 'with according rights' do
      ...
      it "Adds a category from an item form and associates it to the item" do
         sign_in_with_donald
         expect(page).to have_link 'Log out'
         expect(page).to have_content 'Team'
         visit items_url
         expect{
            ...
            fill_in "item_categories_attributes_0_name", with: "Networking"
         ...
         visit categories_url
         expect(page).to have_content "Networking"
         click_link "show_category_#{Category.all.last.id}"
